package io.xiandan.ktx.json.example

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import io.xiandan.ktx.json.*
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val arrayJson = "[\"test\",\"test2\",\"test3\"]"
        ...
        //
        val exampleArrayJson = "[{\"name\":\"test\",\"age\":88},{\"name\":\"test2\",\"age\":99}]"
        val exampleObject = People(name = "test", age = 88)
